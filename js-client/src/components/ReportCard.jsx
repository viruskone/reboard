...
import { Avatar, Chip, CardActionArea } from "@material-ui/core";
    ...
    <Card elevation={1}>
      <CardActionArea onClick={onClicked}>
        <CardHeader
          avatar={
            <Avatar
              className={`${classes.avatar} ${chipColorClasses.chipColor}`}
            >
              {shortcut}
            </Avatar>
          }
        ...
        <CardContent className={classes.content}>
          <Typography
            className={classes.limitDescription}
            paragraph
            color="textSecondary"
          >
            {description}
      ...
      <CardActions className={classes.actions}>
        ...
        <div className={classes.date}>
          <Typography className={classes.actionValue}>
            {createDate.toLocaleString(undefined, {
              day: "numeric",
              month: "long",
              year: "numeric",
            })}
